...
executeCommand "mkdir -p build/lib/arm-linux-gnueabihf/bin/"
echo "Done"
...
executeCommand "cp armhf/redsocks build/lib/arm-linux-gnueabihf/bin/"
executeCommand "cp armhf/chinadns build/lib/arm-linux-gnueabihf/bin/"
